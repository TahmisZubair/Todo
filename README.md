...
Code: [src/components/EmojiPicker.tsx](https://github.com/TahmisZubair/Todo/blob/main/src/components/EmojiPicker.tsx#L116)
...
Users can import and export tasks to/from JSON files. This feature allows users to back up their tasks or transfer them to other devices easily. [Example Import File](https://github.com/TahmisZubair/Todo/blob/main/example-import.json)
...
Code: [scripts/splash-screens](https://github.com/TahmisZubair/Todo/blob/main/scripts/splash-screens)
...
Made with ❤️ by [TahmisZubair](https://github.com/TahmisZubair), licensed under [MIT](https://github.com/TahmisZubair/Todo/blob/main/LICENSE).
